...
CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY DEFAULT NEXTVAL('user_ids'), username CHAR(64) NOT NULL, password CHAR(60) NOT NULL, first_name CHAR(64), last_name CHAR(64));
